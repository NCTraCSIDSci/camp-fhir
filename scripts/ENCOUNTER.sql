-- Generates a RDBMS view of the 'Ecnounter' FHIR resource.
-- This relies on data in PCORNET CDM format and a populated PCORNET_FHIR_MAPPING table.
-- This is a critical view, many FHIR resources rely on encounter_id's to link resources



create or replace view CAMPFHIR_VIEW_ENCOUNTER as
select distinct
