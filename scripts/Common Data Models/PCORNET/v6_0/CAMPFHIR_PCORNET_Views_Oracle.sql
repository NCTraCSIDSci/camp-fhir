...
,	nvl(cmv2.FHIR_OUT_CD,null)	AS	Obs_Interpretation_Coding_Code
...
,	nvl(cmv1.FHIR_OUT_CD,null)	AS	Obs_Value_Quantity_Compartr_Code
...
nvl(cmv1.fhir_out_cd, null) as Patient_Commn_Lang_Coding_Code,
nvl(cmv1.fhir_out_char, null) as Patient_Commn_Lang_Coding_Display,
nvl(cmv1.FHIR_SYSTEM, null) as Patient_Commn_Lang_Coding_System,
...
nvl(cmv1.fhir_out_cd, null) as Patient_Gender_Code,
...
nvl(cmv1.fhir_out_cd, null)	 as Enc_Class__Code,
...
nvl(cmv2.fhir_out_cd, null) as Enc_Hospitalization_DischargeDisposition_Coding_Code,
...
,	nvl(cmv2.FHIR_OUT_CD,null)	AS	Medicationrequest_DosageInstruction_AsNeededBoolean
...
,	nvl(cmv1.FHIR_OUT_CD,null)	AS	Medreq_Doseins_Text
...
,	nvl(cmv3.FHIR_OUT_CD,null)	AS	Medicationrequest_Substitution_AllowedBoolean
...
,	nvl(cmv1.fhir_out_cd, null)	AS	Condition_ClinicalStatus_Coding_Code
...
from
	...
	left join CAMPFHIR_MAPPING_VALUESET cmv1 on cmv1.column_cd='CONDITION_STATUS' and cond.CONDITION_STATUS=cmv1.local_in_cd
...
/
CREATE OR REPLACE VIEW PCORNET_CDM.CAMPFHIR_VIEW_DEVICEMETRIC ( ID, DEVMET_TYPE, DEVMET_UNIT, DEVMET_SOURCE_REF, DEVMET_PARENT_REF, DEVMET_OPERATIONALSTATUS, DEVMET_COLOR, DEVMET_CATEGORY, DEVMET_MEASUREMENTPERIOD, DEVMET_CALIBRATION, DEVMET_CALIBRATION_TYPE, DEVMET_CALIBRATION_STATE, DEVMET_CALIBRATION_TIME )
BEQUEATH DEFINER AS
SELECT
...
nvl(cmv1.fhir_out_cd, null) as Pract_Gender_Code,
...
from pcornet_cdm.procedures px
