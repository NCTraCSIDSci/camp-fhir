...
public class MessageHeaderDao {
	...
	public void persist( main.java.com.campfhir.model.MessageHeader entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.MessageHeader entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.MessageHeader findById(String id) 
	{
		main.java.com.campfhir.model.MessageHeader resource = (main.java.com.campfhir.model.MessageHeader) getCurrentSession().get(main.java.com.campfhir.model.MessageHeader.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.MessageHeader entity) 
	{
