...
public class TestReportDao {
	...
	public void persist( main.java.com.campfhir.model.TestReport entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.TestReport entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.TestReport findById(String id) 
	{
		main.java.com.campfhir.model.TestReport resource = (main.java.com.campfhir.model.TestReport) getCurrentSession().get(main.java.com.campfhir.model.TestReport.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.TestReport entity) 
	{
