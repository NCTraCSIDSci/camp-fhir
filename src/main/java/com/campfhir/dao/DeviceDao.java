...
public class DeviceDao {
	...
	public void persist( main.java.com.campfhir.model.Device entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.Device entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.Device findById(String id) 
	{
		main.java.com.campfhir.model.Device resource = (main.java.com.campfhir.model.Device) getCurrentSession().get(main.java.com.campfhir.model.Device.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.Device entity) 
	{
	...
	{
		ScrollableResults resources = getCurrentSession().createQuery("FROM Device")
