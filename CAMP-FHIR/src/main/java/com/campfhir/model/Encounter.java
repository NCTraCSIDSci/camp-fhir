...
public class Encounter 
{
	...
	String ENC_TYPE_CODEABLECONCEPT_CODING;
	...
	public String getENC_TYPE_CODEABLECONCEPT_CODING() {
		return this.ENC_TYPE_CODEABLECONCEPT_CODING;
	}

	public void setENC_TYPE_CODEABLECONCEPT_CODING(String eNC_TYPE_CODEABLECONCEPT_CODING) {
		this.ENC_TYPE_CODEABLECONCEPT_CODING = ENC_TYPE_CODEABLECONCEPT_CODING;
	}
