...
public class ContractBidirectionalConversion 
{
	public Contract Contracts(org.hl7.fhir.r4.model.Contract contract) throws ParseException
	{
		...
		if(contracttermactionoccurrencetimingrepeatboundsduration.hasValue()) {
			c.setCnctTrmActnOccrnceTmgRptBndsDurationVl(String.valueOf(contracttermactionoccurrencetimingrepeatboundsduration.getValue()));
		}
		...
		c.setCnctTrmActnOccrnceTmgRptBndsDurationCmprtr(contracttermactionoccurrencetimingrepeatboundsdurationcomparator.toCode());

		/******************** Cnct_Trm_Actn_OccrnceTmg_Rpt_BndsDuration_Cd ********************************************************************************/
		if(contracttermactionoccurrencetimingrepeatboundsduration.hasCode()) {
			c.setCnctTrmActnOccrnceTmgRptBndsDurationCd(String.valueOf(contracttermactionoccurrencetimingrepeatboundsduration.getCode()));
		}
		/******************** Cnct_Trm_Actn_OccrnceTmg_Rpt_BndsDuration_Unt ********************************************************************************/
		if(contracttermactionoccurrencetimingrepeatboundsduration.hasUnit()) {
			c.setCnctTrmActnOccrnceTmgRptBndsDurationUnt(String.valueOf(contracttermactionoccurrencetimingrepeatboundsduration.getUnit()));
		}
		/******************** Cnct_Trm_Actn_OccrnceTmg_Rpt_BndsDuration_Sys ********************************************************************************/
		if(contracttermactionoccurrencetimingrepeatboundsduration.hasSystem()) {
			c.setCnctTrmActnOccrnceTmgRptBndsDurationSys(String.valueOf(contracttermactionoccurrencetimingrepeatboundsduration.getSystem()));
		}
