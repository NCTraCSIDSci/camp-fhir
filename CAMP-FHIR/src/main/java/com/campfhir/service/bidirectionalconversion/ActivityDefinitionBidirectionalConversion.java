...
public class ActivityDefinitionBidirectionalConversion 
{
	public ActivityDefinition ActivityDefinitions(org.hl7.fhir.r4.model.ActivityDefinition activitydefinition) throws ParseException
	{
		...
		if(activitydefinitiondosagetimingrepeatboundsduration.hasValue()) {
			a.setActvtyDfnDsgTmgRptBndsDurationVl(String.valueOf(activitydefinitiondosagetimingrepeatboundsduration.getValue()));
		}
		...
		a.setActvtyDfnDsgTmgRptBndsDurationCmprtr(activitydefinitiondosagetimingrepeatboundsdurationcomparator.toCode());

		/******************** ActvtyDfn_Dsg_Tmg_Rpt_BndsDuration_Cd ********************************************************************************/
		if(activitydefinitiondosagetimingrepeatboundsduration.hasCode()) {
			a.setActvtyDfnDsgTmgRptBndsDurationCd(String.valueOf(activitydefinitiondosagetimingrepeatboundsduration.getCode()));
		}
		/******************** ActvtyDfn_Dsg_Tmg_Rpt_BndsDuration_Unt ********************************************************************************/
		if(activitydefinitiondosagetimingrepeatboundsduration.hasUnit()) {
			a.setActvtyDfnDsgTmgRptBndsDurationUnt(String.valueOf(activitydefinitiondosagetimingrepeatboundsduration.getUnit()));
		}
		/******************** ActvtyDfn_Dsg_Tmg_Rpt_BndsDuration_Sys ********************************************************************************/
		if(activitydefinitiondosagetimingrepeatboundsduration.hasSystem()) {
			a.setActvtyDfnDsgTmgRptBndsDurationSys(String.valueOf(activitydefinitiondosagetimingrepeatboundsduration.getSystem()));
		}
		...
		if(activitydefinitiontimingtimingrepeatboundsduration.hasValue()) {
			a.setActvtyDfnTmgTmgRptBndsDurationVl(String.valueOf(activitydefinitiontimingtimingrepeatboundsduration.getValue()));
		}
		...
		a.setActvtyDfnTmgTmgRptBndsDurationCmprtr(activitydefinitiontimingtimingrepeatboundsdurationcomparator.toCode());

		/******************** ActvtyDfn_TmgTmg_Rpt_BndsDuration_Cd ********************************************************************************/
		if(activitydefinitiontimingtimingrepeatboundsduration.hasCode()) {
			a.setActvtyDfnTmgTmgRptBndsDurationCd(String.valueOf(activitydefinitiontimingtimingrepeatboundsduration.getCode()));
		}
		/******************** ActvtyDfn_TmgTmg_Rpt_BndsDuration_Unt ********************************************************************************/
		if(activitydefinitiontimingtimingrepeatboundsduration.hasUnit()) {
			a.setActvtyDfnTmgTmgRptBndsDurationUnt(String.valueOf(activitydefinitiontimingtimingrepeatboundsduration.getUnit()));
		}
		/******************** ActvtyDfn_TmgTmg_Rpt_BndsDuration_Sys ********************************************************************************/
		if(activitydefinitiontimingtimingrepeatboundsduration.hasSystem()) {
			a.setActvtyDfnTmgTmgRptBndsDurationSys(String.valueOf(activitydefinitiontimingtimingrepeatboundsduration.getSystem()));
		}
		...
		if(activitydefinitiontimingage.hasValue()) {
			a.setActvtyDfnTmgAgeVl(String.valueOf(activitydefinitiontimingage.getValue()));
		}
		...
		a.setActvtyDfnTmgAgeCmprtr(activitydefinitiontimingagecomparator.toCode());

		/******************** ActvtyDfn_TmgAge_Cd ********************************************************************************/
		if(activitydefinitiontimingage.hasCode()) {
			a.setActvtyDfnTmgAgeCd(String.valueOf(activitydefinitiontimingage.getCode()));
		}
		/******************** ActvtyDfn_TmgAge_Unt ********************************************************************************/
		if(activitydefinitiontimingage.hasUnit()) {
			a.setActvtyDfnTmgAgeUnt(String.valueOf(activitydefinitiontimingage.getUnit()));
		}
		/******************** ActvtyDfn_TmgAge_Sys ********************************************************************************/
		if(activitydefinitiontimingage.hasSystem()) {
			a.setActvtyDfnTmgAgeSys(String.valueOf(activitydefinitiontimingage.getSystem()));
		}
		...
		if(activitydefinitiontimingduration.hasValue()) {
			a.setActvtyDfnTmgDurationVl(String.valueOf(activitydefinitiontimingduration.getValue()));
		}
		...
		a.setActvtyDfnTmgDurationCmprtr(activitydefinitiontimingdurationcomparator.toCode());

		/******************** ActvtyDfn_TmgDuration_Cd ********************************************************************************/
		if(activitydefinitiontimingduration.hasCode()) {
			a.setActvtyDfnTmgDurationCd(String.valueOf(activitydefinitiontimingduration.getCode()));
		}
		/******************** ActvtyDfn_TmgDuration_Unt ********************************************************************************/
		if(activitydefinitiontimingduration.hasUnit()) {
			a.setActvtyDfnTmgDurationUnt(String.valueOf(activitydefinitiontimingduration.getUnit()));
		}
		/******************** ActvtyDfn_TmgDuration_Sys ********************************************************************************/
		if(activitydefinitiontimingduration.hasSystem()) {
			a.setActvtyDfnTmgDurationSys(String.valueOf(activitydefinitiontimingduration.getSystem()));
		}
