...
public class SpecimenBidirectionalConversion 
{
	public Specimen Specimens(org.hl7.fhir.r4.model.Specimen specimen) throws ParseException
	{
		...
		if(specimencollectionfastingstatusduration.hasValue()) {
			s.setSpcmnCollectionFastingStsDurationVl(String.valueOf(specimencollectionfastingstatusduration.getValue()));
		}
		...
		s.setSpcmnCollectionFastingStsDurationCmprtr(specimencollectionfastingstatusdurationcomparator.toCode());

		/******************** Spcmn_Collection_FastingStsDuration_Cd ********************************************************************************/
		if(specimencollectionfastingstatusduration.hasCode()) {
			s.setSpcmnCollectionFastingStsDurationCd(String.valueOf(specimencollectionfastingstatusduration.getCode()));
		}
		/******************** Spcmn_Collection_FastingStsDuration_Unt ********************************************************************************/
		if(specimencollectionfastingstatusduration.hasUnit()) {
			s.setSpcmnCollectionFastingStsDurationUnt(String.valueOf(specimencollectionfastingstatusduration.getUnit()));
		}
		/******************** Spcmn_Collection_FastingStsDuration_Sys ********************************************************************************/
		if(specimencollectionfastingstatusduration.hasSystem()) {
			s.setSpcmnCollectionFastingStsDurationSys(String.valueOf(specimencollectionfastingstatusduration.getSystem()));
		}
		...
		if(specimencollectionduration.hasValue()) {
			s.setSpcmnCollectionDurationVl(String.valueOf(specimencollectionduration.getValue()));
		}
		...
		s.setSpcmnCollectionDurationCmprtr(specimencollectiondurationcomparator.toCode());

		/******************** Spcmn_Collection_Duration_Cd ********************************************************************************/
		if(specimencollectionduration.hasCode()) {
			s.setSpcmnCollectionDurationCd(String.valueOf(specimencollectionduration.getCode()));
		}
		/******************** Spcmn_Collection_Duration_Unt ********************************************************************************/
		if(specimencollectionduration.hasUnit()) {
			s.setSpcmnCollectionDurationUnt(String.valueOf(specimencollectionduration.getUnit()));
		}
		/******************** Spcmn_Collection_Duration_Sys ********************************************************************************/
		if(specimencollectionduration.hasSystem()) {
			s.setSpcmnCollectionDurationSys(String.valueOf(specimencollectionduration.getSystem()));
		}
