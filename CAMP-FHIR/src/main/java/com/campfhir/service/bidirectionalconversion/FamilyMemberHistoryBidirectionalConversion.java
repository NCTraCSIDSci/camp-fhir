...
public class FamilyMemberHistoryBidirectionalConversion 
{
	public FamilyMemberHistory FamilyMemberHistorys(org.hl7.fhir.r4.model.FamilyMemberHistory familymemberhistory) throws ParseException
	{
		...
		if(familymemberhistoryageage.hasValue()) {
			f.setFmlyMmbrHisAgeAgeVl(String.valueOf(familymemberhistoryageage.getValue()));
		}
		...
		f.setFmlyMmbrHisAgeAgeCmprtr(familymemberhistoryageagecomparator.toCode());

		/******************** FmlyMmbrHis_AgeAge_Cd ********************************************************************************/
		if(familymemberhistoryageage.hasCode()) {
			f.setFmlyMmbrHisAgeAgeCd(String.valueOf(familymemberhistoryageage.getCode()));
		}
		/******************** FmlyMmbrHis_AgeAge_Unt ********************************************************************************/
		if(familymemberhistoryageage.hasUnit()) {
			f.setFmlyMmbrHisAgeAgeUnt(String.valueOf(familymemberhistoryageage.getUnit()));
		}
		/******************** FmlyMmbrHis_AgeAge_Sys ********************************************************************************/
		if(familymemberhistoryageage.hasSystem()) {
			f.setFmlyMmbrHisAgeAgeSys(String.valueOf(familymemberhistoryageage.getSystem()));
		}
		...
		if(familymemberhistorydeceasedage.hasValue()) {
			f.setFmlyMmbrHisDeceasedAgeVl(String.valueOf(familymemberhistorydeceasedage.getValue()));
		}
		...
		f.setFmlyMmbrHisDeceasedAgeCmprtr(familymemberhistorydeceasedagecomparator.toCode());

		/******************** FmlyMmbrHis_DeceasedAge_Cd ********************************************************************************/
		if(familymemberhistorydeceasedage.hasCode()) {
			f.setFmlyMmbrHisDeceasedAgeCd(String.valueOf(familymemberhistorydeceasedage.getCode()));
		}
		/******************** FmlyMmbrHis_DeceasedAge_Unt ********************************************************************************/
		if(familymemberhistorydeceasedage.hasUnit()) {
			f.setFmlyMmbrHisDeceasedAgeUnt(String.valueOf(familymemberhistorydeceasedage.getUnit()));
		}
		/******************** FmlyMmbrHis_DeceasedAge_Sys ********************************************************************************/
		if(familymemberhistorydeceasedage.hasSystem()) {
			f.setFmlyMmbrHisDeceasedAgeSys(String.valueOf(familymemberhistorydeceasedage.getSystem()));
		}
		...
		if(familymemberhistoryconditiononage.hasValue()) {
			f.setFmlyMmbrHisCndtnOnAgeVl(String.valueOf(familymemberhistoryconditiononage.getValue()));
		}
		...
		f.setFmlyMmbrHisCndtnOnAgeCmprtr(familymemberhistoryconditiononagecomparator.toCode());

		/******************** FmlyMmbrHis_Cndtn_OnAge_Cd ********************************************************************************/
		if(familymemberhistoryconditiononage.hasCode()) {
			f.setFmlyMmbrHisCndtnOnAgeCd(String.valueOf(familymemberhistoryconditiononage.getCode()));
		}
		/******************** FmlyMmbrHis_Cndtn_OnAge_Unt ********************************************************************************/
		if(familymemberhistoryconditiononage.hasUnit()) {
			f.setFmlyMmbrHisCndtnOnAgeUnt(String.valueOf(familymemberhistoryconditiononage.getUnit()));
		}
		/******************** FmlyMmbrHis_Cndtn_OnAge_Sys ********************************************************************************/
		if(familymemberhistoryconditiononage.hasSystem()) {
			f.setFmlyMmbrHisCndtnOnAgeSys(String.valueOf(familymemberhistoryconditiononage.getSystem()));
		}
