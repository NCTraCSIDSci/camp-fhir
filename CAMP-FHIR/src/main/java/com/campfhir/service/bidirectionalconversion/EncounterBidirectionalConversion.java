...
public class EncounterBidirectionalConversion 
{
	public Encounter Encounters(org.hl7.fhir.r4.model.Encounter encounter) throws ParseException
	{
		...
		if(encounterlength.hasValue()) {
			e.setEncLengthVl(String.valueOf(encounterlength.getValue()));
		}
		...
		e.setEncLengthCmprtr(encounterlengthcomparator.toCode());

		/******************** Enc_Length_Cd ********************************************************************************/
		if(encounterlength.hasCode()) {
			e.setEncLengthCd(String.valueOf(encounterlength.getCode()));
		}
		/******************** Enc_Length_Unt ********************************************************************************/
		if(encounterlength.hasUnit()) {
			e.setEncLengthUnt(String.valueOf(encounterlength.getUnit()));
		}
		/******************** Enc_Length_Sys ********************************************************************************/
		if(encounterlength.hasSystem()) {
			e.setEncLengthSys(String.valueOf(encounterlength.getSystem()));
		}
		/******************** encounterpriority ********************************************************************************/
