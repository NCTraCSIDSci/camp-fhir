...
public class ObservationBidirectionalConversion 
{
	public Observation Observations(org.hl7.fhir.r4.model.Observation observation) throws ParseException
	{
		...
		if(observationeffectivetimingrepeatboundsduration.hasValue()) {
			o.setObsrvtnEfctiveTmgRptBndsDurationVl(String.valueOf(observationeffectivetimingrepeatboundsduration.getValue()));
		}
		...
		o.setObsrvtnEfctiveTmgRptBndsDurationCmprtr(observationeffectivetimingrepeatboundsdurationcomparator.toCode());

		/******************** Obsrvtn_EfctiveTmg_Rpt_BndsDuration_Cd ********************************************************************************/
		if(observationeffectivetimingrepeatboundsduration.hasCode()) {
			o.setObsrvtnEfctiveTmgRptBndsDurationCd(String.valueOf(observationeffectivetimingrepeatboundsduration.getCode()));
		}
		/******************** Obsrvtn_EfctiveTmg_Rpt_BndsDuration_Unt ********************************************************************************/
		if(observationeffectivetimingrepeatboundsduration.hasUnit()) {
			o.setObsrvtnEfctiveTmgRptBndsDurationUnt(String.valueOf(observationeffectivetimingrepeatboundsduration.getUnit()));
		}
		/******************** Obsrvtn_EfctiveTmg_Rpt_BndsDuration_Sys ********************************************************************************/
		if(observationeffectivetimingrepeatboundsduration.hasSystem()) {
			o.setObsrvtnEfctiveTmgRptBndsDurationSys(String.valueOf(observationeffectivetimingrepeatboundsduration.getSystem()));
		}
