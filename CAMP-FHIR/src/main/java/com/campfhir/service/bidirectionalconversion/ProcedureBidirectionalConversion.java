...
public class ProcedureBidirectionalConversion 
{
	public Procedure Procedures(org.hl7.fhir.r4.model.Procedure procedure) throws ParseException
	{
		...
		if(procedureperformedage.hasValue()) {
			p.setPrcdrPerformedAgeVl(String.valueOf(procedureperformedage.getValue()));
		}
		...
		p.setPrcdrPerformedAgeCmprtr(procedureperformedagecomparator.toCode());

		/******************** Prcdr_PerformedAge_Cd ********************************************************************************/
		if(procedureperformedage.hasCode()) {
			p.setPrcdrPerformedAgeCd(String.valueOf(procedureperformedage.getCode()));
		}
		/******************** Prcdr_PerformedAge_Unt ********************************************************************************/
		if(procedureperformedage.hasUnit()) {
			p.setPrcdrPerformedAgeUnt(String.valueOf(procedureperformedage.getUnit()));
		}
		/******************** Prcdr_PerformedAge_Sys ********************************************************************************/
		if(procedureperformedage.hasSystem()) {
			p.setPrcdrPerformedAgeSys(String.valueOf(procedureperformedage.getSystem()));
		}
		/******************** Prcdr_Rpt ********************************************************************************/
