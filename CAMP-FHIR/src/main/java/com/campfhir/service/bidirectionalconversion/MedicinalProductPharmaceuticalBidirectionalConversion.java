...
public class MedicinalProductPharmaceuticalBidirectionalConversion 
{
	public MedicinalProductPharmaceutical MedicinalProductPharmaceuticals(org.hl7.fhir.r4.model.MedicinalProductPharmaceutical medicinalproductpharmaceutical) throws ParseException
	{
		...
		if(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.hasValue()) {
			m.setMdcnlPrdctPhrmctclRtOfAdmnstnMxTrtmntPrdVl(String.valueOf(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.getValue()));
		}
		...
		m.setMdcnlPrdctPhrmctclRtOfAdmnstnMxTrtmntPrdCmprtr(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiodcomparator.toCode());
		...
		if(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.hasCode()) {
			m.setMdcnlPrdctPhrmctclRtOfAdmnstnMxTrtmntPrdCd(String.valueOf(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.getCode()));
		}
		...
		if(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.hasUnit()) {
			m.setMdcnlPrdctPhrmctclRtOfAdmnstnMxTrtmntPrdUnt(String.valueOf(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.getUnit()));
		}
		...
		if(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.hasSystem()) {
			m.setMdcnlPrdctPhrmctclRtOfAdmnstnMxTrtmntPrdSys(String.valueOf(medicinalproductpharmaceuticalrouteofadministrationmaxtreatmentperiod.getSystem()));
		}
