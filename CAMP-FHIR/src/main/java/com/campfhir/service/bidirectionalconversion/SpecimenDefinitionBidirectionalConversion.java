...
public class SpecimenDefinitionBidirectionalConversion 
{
	public SpecimenDefinition SpecimenDefinitions(org.hl7.fhir.r4.model.SpecimenDefinition specimendefinition) throws ParseException
	{
		...
		if(specimendefinitiontypetestedretentiontime.hasValue()) {
			s.setSpcmnDfnTypTstedRetentionTimeVl(String.valueOf(specimendefinitiontypetestedretentiontime.getValue()));
		}
		...
		s.setSpcmnDfnTypTstedRetentionTimeCmprtr(specimendefinitiontypetestedretentiontimecomparator.toCode());

		/******************** SpcmnDfn_TypTsted_RetentionTime_Cd ********************************************************************************/
		if(specimendefinitiontypetestedretentiontime.hasCode()) {
			s.setSpcmnDfnTypTstedRetentionTimeCd(String.valueOf(specimendefinitiontypetestedretentiontime.getCode()));
		}
		/******************** SpcmnDfn_TypTsted_RetentionTime_Unt ********************************************************************************/
		if(specimendefinitiontypetestedretentiontime.hasUnit()) {
			s.setSpcmnDfnTypTstedRetentionTimeUnt(String.valueOf(specimendefinitiontypetestedretentiontime.getUnit()));
		}
		/******************** SpcmnDfn_TypTsted_RetentionTime_Sys ********************************************************************************/
		if(specimendefinitiontypetestedretentiontime.hasSystem()) {
			s.setSpcmnDfnTypTstedRetentionTimeSys(String.valueOf(specimendefinitiontypetestedretentiontime.getSystem()));
		}
		...
		if(specimendefinitiontypetestedhandlingmaxduration.hasValue()) {
			s.setSpcmnDfnTypTstedHandlingMxDurationVl(String.valueOf(specimendefinitiontypetestedhandlingmaxduration.getValue()));
		}
		...
		s.setSpcmnDfnTypTstedHandlingMxDurationCmprtr(specimendefinitiontypetestedhandlingmaxdurationcomparator.toCode());

		/******************** SpcmnDfn_TypTsted_Handling_MxDuration_Cd ********************************************************************************/
		if(specimendefinitiontypetestedhandlingmaxduration.hasCode()) {
			s.setSpcmnDfnTypTstedHandlingMxDurationCd(String.valueOf(specimendefinitiontypetestedhandlingmaxduration.getCode()));
		}
		/******************** SpcmnDfn_TypTsted_Handling_MxDuration_Unt ********************************************************************************/
		if(specimendefinitiontypetestedhandlingmaxduration.hasUnit()) {
			s.setSpcmnDfnTypTstedHandlingMxDurationUnt(String.valueOf(specimendefinitiontypetestedhandlingmaxduration.getUnit()));
		}
		/******************** SpcmnDfn_TypTsted_Handling_MxDuration_Sys ********************************************************************************/
		if(specimendefinitiontypetestedhandlingmaxduration.hasSystem()) {
			s.setSpcmnDfnTypTstedHandlingMxDurationSys(String.valueOf(specimendefinitiontypetestedhandlingmaxduration.getSystem()));
		}
