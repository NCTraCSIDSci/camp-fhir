...
public class SupplyRequestBidirectionalConversion 
{
	public SupplyRequest SupplyRequests(org.hl7.fhir.r4.model.SupplyRequest supplyrequest) throws ParseException
	{
		...
		if(supplyrequestoccurrencetimingrepeatboundsduration.hasValue()) {
			s.setSpplyRqstOccrnceTmgRptBndsDurationVl(String.valueOf(supplyrequestoccurrencetimingrepeatboundsduration.getValue()));
		}
		...
		s.setSpplyRqstOccrnceTmgRptBndsDurationCmprtr(supplyrequestoccurrencetimingrepeatboundsdurationcomparator.toCode());

		/******************** SpplyRqst_OccrnceTmg_Rpt_BndsDuration_Cd ********************************************************************************/
		if(supplyrequestoccurrencetimingrepeatboundsduration.hasCode()) {
			s.setSpplyRqstOccrnceTmgRptBndsDurationCd(String.valueOf(supplyrequestoccurrencetimingrepeatboundsduration.getCode()));
		}
		/******************** SpplyRqst_OccrnceTmg_Rpt_BndsDuration_Unt ********************************************************************************/
		if(supplyrequestoccurrencetimingrepeatboundsduration.hasUnit()) {
			s.setSpplyRqstOccrnceTmgRptBndsDurationUnt(String.valueOf(supplyrequestoccurrencetimingrepeatboundsduration.getUnit()));
		}
		/******************** SpplyRqst_OccrnceTmg_Rpt_BndsDuration_Sys ********************************************************************************/
		if(supplyrequestoccurrencetimingrepeatboundsduration.hasSystem()) {
			s.setSpplyRqstOccrnceTmgRptBndsDurationSys(String.valueOf(supplyrequestoccurrencetimingrepeatboundsduration.getSystem()));
		}
