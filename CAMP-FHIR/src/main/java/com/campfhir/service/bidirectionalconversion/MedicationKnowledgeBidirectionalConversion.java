...
public class MedicationKnowledgeBidirectionalConversion 
{
	public MedicationKnowledge MedicationKnowledges(org.hl7.fhir.r4.model.MedicationKnowledge medicationknowledge) throws ParseException
	{
		...
		if(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.hasValue()) {
			m.setMdctnKnldgAdmnGdlnsDsgDsgTmgRptBndsDurationVl(String.valueOf(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.getValue()));
		}
		...
		m.setMdctnKnldgAdmnGdlnsDsgDsgTmgRptBndsDurationCmprtr(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsdurationcomparator.toCode());
		...
		if(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.hasCode()) {
			m.setMdctnKnldgAdmnGdlnsDsgDsgTmgRptBndsDurationCd(String.valueOf(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.getCode()));
		}
		...
		if(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.hasUnit()) {
			m.setMdctnKnldgAdmnGdlnsDsgDsgTmgRptBndsDurationUnt(String.valueOf(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.getUnit()));
		}
		...
		if(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.hasSystem()) {
			m.setMdctnKnldgAdmnGdlnsDsgDsgTmgRptBndsDurationSys(String.valueOf(medicationknowledgeadministrationguidelinesdosagedosagetimingrepeatboundsduration.getSystem()));
		}
		...
		if(medicationknowledgeregulatorymaxdispenseperiod.hasValue()) {
			m.setMdctnKnldgRegulatoryMxDispnsPrdVl(String.valueOf(medicationknowledgeregulatorymaxdispenseperiod.getValue()));
		}
		...
		m.setMdctnKnldgRegulatoryMxDispnsPrdCmprtr(medicationknowledgeregulatorymaxdispenseperiodcomparator.toCode());

		/******************** MdctnKnldg_Regulatory_MxDispns_Prd_Cd ********************************************************************************/
		if(medicationknowledgeregulatorymaxdispenseperiod.hasCode()) {
			m.setMdctnKnldgRegulatoryMxDispnsPrdCd(String.valueOf(medicationknowledgeregulatorymaxdispenseperiod.getCode()));
		}
		/******************** MdctnKnldg_Regulatory_MxDispns_Prd_Unt ********************************************************************************/
		if(medicationknowledgeregulatorymaxdispenseperiod.hasUnit()) {
			m.setMdctnKnldgRegulatoryMxDispnsPrdUnt(String.valueOf(medicationknowledgeregulatorymaxdispenseperiod.getUnit()));
		}
		/******************** MdctnKnldg_Regulatory_MxDispns_Prd_Sys ********************************************************************************/
		if(medicationknowledgeregulatorymaxdispenseperiod.hasSystem()) {
			m.setMdctnKnldgRegulatoryMxDispnsPrdSys(String.valueOf(medicationknowledgeregulatorymaxdispenseperiod.getSystem()));
		}
		...
		if(medicationknowledgekineticshalflifeperiod.hasValue()) {
			m.setMdctnKnldgKineticsHalfLifePrdVl(String.valueOf(medicationknowledgekineticshalflifeperiod.getValue()));
		}
		...
		m.setMdctnKnldgKineticsHalfLifePrdCmprtr(medicationknowledgekineticshalflifeperiodcomparator.toCode());

		/******************** MdctnKnldg_Kinetics_HalfLifePrd_Cd ********************************************************************************/
		if(medicationknowledgekineticshalflifeperiod.hasCode()) {
			m.setMdctnKnldgKineticsHalfLifePrdCd(String.valueOf(medicationknowledgekineticshalflifeperiod.getCode()));
		}
		/******************** MdctnKnldg_Kinetics_HalfLifePrd_Unt ********************************************************************************/
		if(medicationknowledgekineticshalflifeperiod.hasUnit()) {
			m.setMdctnKnldgKineticsHalfLifePrdUnt(String.valueOf(medicationknowledgekineticshalflifeperiod.getUnit()));
		}
		/******************** MdctnKnldg_Kinetics_HalfLifePrd_Sys ********************************************************************************/
		if(medicationknowledgekineticshalflifeperiod.hasSystem()) {
			m.setMdctnKnldgKineticsHalfLifePrdSys(String.valueOf(medicationknowledgekineticshalflifeperiod.getSystem()));
		}
