...
{
	public Bundle MedicationRequests(List<MedicationRequest> medications) throws ParseException, FHIRException, IOException
	{		
		...
		{	
			 ...
			 ********************************************************************************************************************/
			Reference reference3 = new Reference().setReference(medication.getMED_MEDREF_REFERENCE());
			n.setMedication(reference3);
	...
	public static  EncounterHospitalizationComponent setDischargeDisp(Encounter n) throws FHIRException
	{
		...
		Coding p = new Coding();
		p.setCode(n.getENC_HOSP_DISDISP_CODING_CODE());
		p.setDisplay(n.getENC_HOSP_DISDISP_TEXT());
		p.setSystem(n.getENC_HOSP_DISDISP_CODING_SYST());
