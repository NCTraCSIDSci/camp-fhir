...
public class ValueSetDao {
	...
	public void persist( main.java.com.campfhir.model.ValueSet entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.ValueSet entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.ValueSet findById(String id) 
	{
		main.java.com.campfhir.model.ValueSet resource = (main.java.com.campfhir.model.ValueSet) getCurrentSession().get(main.java.com.campfhir.model.ValueSet.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.ValueSet entity) 
	{
