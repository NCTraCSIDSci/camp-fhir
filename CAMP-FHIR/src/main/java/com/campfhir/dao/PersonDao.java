...
public class PersonDao {
	...
	public void persist( main.java.com.campfhir.model.Person entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.Person entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.Person findById(String id) 
	{
		main.java.com.campfhir.model.Person resource = (main.java.com.campfhir.model.Person) getCurrentSession().get(main.java.com.campfhir.model.Person.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.Person entity) 
	{
