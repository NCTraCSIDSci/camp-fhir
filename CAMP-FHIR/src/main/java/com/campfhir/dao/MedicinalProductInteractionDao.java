...
public class MedicinalProductInteractionDao {
	...
	public void persist( main.java.com.campfhir.model.MedicinalProductInteraction entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.MedicinalProductInteraction entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.MedicinalProductInteraction findById(String id) 
	{
		main.java.com.campfhir.model.MedicinalProductInteraction resource = (main.java.com.campfhir.model.MedicinalProductInteraction) getCurrentSession().get(main.java.com.campfhir.model.MedicinalProductInteraction.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.MedicinalProductInteraction entity) 
	{
