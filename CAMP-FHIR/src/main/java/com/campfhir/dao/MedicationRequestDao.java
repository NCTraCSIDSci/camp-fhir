...
public class MedicationRequestDao {
	...
	public void persist( main.java.com.campfhir.model.MedicationRequest entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.MedicationRequest entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.MedicationRequest findById(String id) 
	{
		main.java.com.campfhir.model.MedicationRequest resource = (main.java.com.campfhir.model.MedicationRequest) getCurrentSession().get(main.java.com.campfhir.model.MedicationRequest.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.MedicationRequest entity) 
	{
