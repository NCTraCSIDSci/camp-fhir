...
public class ResearchElementDefinitionDao {
	...
	public void persist( main.java.com.campfhir.model.ResearchElementDefinition entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.ResearchElementDefinition entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.ResearchElementDefinition findById(String id) 
	{
		main.java.com.campfhir.model.ResearchElementDefinition resource = (main.java.com.campfhir.model.ResearchElementDefinition) getCurrentSession().get(main.java.com.campfhir.model.ResearchElementDefinition.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.ResearchElementDefinition entity) 
	{
