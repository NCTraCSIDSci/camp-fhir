...
public class CoverageEligibilityRequestDao {
	...
	public void persist( main.java.com.campfhir.model.CoverageEligibilityRequest entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.CoverageEligibilityRequest entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.CoverageEligibilityRequest findById(String id) 
	{
		main.java.com.campfhir.model.CoverageEligibilityRequest resource = (main.java.com.campfhir.model.CoverageEligibilityRequest) getCurrentSession().get(main.java.com.campfhir.model.CoverageEligibilityRequest.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.CoverageEligibilityRequest entity) 
	{
