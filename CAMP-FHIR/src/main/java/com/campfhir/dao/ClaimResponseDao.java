...
public class ClaimResponseDao {
	...
	public void persist( main.java.com.campfhir.model.ClaimResponse entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.ClaimResponse entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.ClaimResponse findById(String id) 
	{
		main.java.com.campfhir.model.ClaimResponse resource = (main.java.com.campfhir.model.ClaimResponse) getCurrentSession().get(main.java.com.campfhir.model.ClaimResponse.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.ClaimResponse entity) 
	{
