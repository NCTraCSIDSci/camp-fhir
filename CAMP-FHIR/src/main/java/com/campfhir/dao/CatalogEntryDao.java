...
public class CatalogEntryDao {
	...
	public void persist( main.java.com.campfhir.model.CatalogEntry entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.java.com.campfhir.model.CatalogEntry entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.java.com.campfhir.model.CatalogEntry findById(String id) 
	{
		main.java.com.campfhir.model.CatalogEntry resource = (main.java.com.campfhir.model.CatalogEntry) getCurrentSession().get(main.java.com.campfhir.model.CatalogEntry.class, id);
		return resource; 
	}
	
	public void delete(main.java.com.campfhir.model.CatalogEntry entity) 
	{
