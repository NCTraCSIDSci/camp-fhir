...
public class MedicationstatementDao {
	...
	public void persist( main.templateoutput.Model.Medicationstatement entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Medicationstatement entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Medicationstatement findById(String id) 
	{
		main.templateoutput.Model.Medicationstatement resource = (main.templateoutput.Model.Medicationstatement) getCurrentSession().get(main.templateoutput.Model.Medicationstatement.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Medicationstatement entity) 
	{
