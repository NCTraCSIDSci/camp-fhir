...
public class EvidenceDao {
	...
	public void persist( main.templateoutput.Model.Evidence entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Evidence entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Evidence findById(String id) 
	{
		main.templateoutput.Model.Evidence resource = (main.templateoutput.Model.Evidence) getCurrentSession().get(main.templateoutput.Model.Evidence.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Evidence entity) 
	{
