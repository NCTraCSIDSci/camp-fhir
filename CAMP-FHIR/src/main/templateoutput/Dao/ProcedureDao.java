...
public class ProcedureDao {
	...
	public void persist( main.templateoutput.Model.Procedure entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Procedure entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Procedure findById(String id) 
	{
		main.templateoutput.Model.Procedure resource = (main.templateoutput.Model.Procedure) getCurrentSession().get(main.templateoutput.Model.Procedure.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Procedure entity) 
	{
