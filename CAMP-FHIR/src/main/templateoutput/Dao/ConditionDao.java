...
public class ConditionDao {
	...
	public void persist( main.templateoutput.Model.Condition entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Condition entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Condition findById(String id) 
	{
		main.templateoutput.Model.Condition resource = (main.templateoutput.Model.Condition) getCurrentSession().get(main.templateoutput.Model.Condition.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Condition entity) 
	{
