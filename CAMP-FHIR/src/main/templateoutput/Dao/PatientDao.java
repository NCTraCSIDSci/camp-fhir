...
public class PatientDao {
	...
	public void persist( main.templateoutput.Model.Patient entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Patient entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Patient findById(String id) 
	{
		main.templateoutput.Model.Patient resource = (main.templateoutput.Model.Patient) getCurrentSession().get(main.templateoutput.Model.Patient.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Patient entity) 
	{
