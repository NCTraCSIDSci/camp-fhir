...
public class ObservationDao {
	...
	public void persist( main.templateoutput.Model.Observation entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Observation entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Observation findById(String id) 
	{
		main.templateoutput.Model.Observation resource = (main.templateoutput.Model.Observation) getCurrentSession().get(main.templateoutput.Model.Observation.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Observation entity) 
	{
