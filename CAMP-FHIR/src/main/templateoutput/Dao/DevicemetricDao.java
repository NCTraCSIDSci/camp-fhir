...
public class DevicemetricDao {
	...
	public void persist( main.templateoutput.Model.Devicemetric entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Devicemetric entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Devicemetric findById(String id) 
	{
		main.templateoutput.Model.Devicemetric resource = (main.templateoutput.Model.Devicemetric) getCurrentSession().get(main.templateoutput.Model.Devicemetric.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Devicemetric entity) 
	{
