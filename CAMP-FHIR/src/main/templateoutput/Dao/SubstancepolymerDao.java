...
public class SubstancepolymerDao {
	...
	public void persist( main.templateoutput.Model.Substancepolymer entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Substancepolymer entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Substancepolymer findById(String id) 
	{
		main.templateoutput.Model.Substancepolymer resource = (main.templateoutput.Model.Substancepolymer) getCurrentSession().get(main.templateoutput.Model.Substancepolymer.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Substancepolymer entity) 
	{
