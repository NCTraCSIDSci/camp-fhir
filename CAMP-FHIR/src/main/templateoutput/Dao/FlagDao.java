...
public class FlagDao {
	...
	public void persist( main.templateoutput.Model.Flag entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Flag entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Flag findById(String id) 
	{
		main.templateoutput.Model.Flag resource = (main.templateoutput.Model.Flag) getCurrentSession().get(main.templateoutput.Model.Flag.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Flag entity) 
	{
