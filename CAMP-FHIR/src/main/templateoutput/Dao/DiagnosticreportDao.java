...
public class DiagnosticreportDao {
	...
	public void persist( main.templateoutput.Model.Diagnosticreport entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Diagnosticreport entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Diagnosticreport findById(String id) 
	{
		main.templateoutput.Model.Diagnosticreport resource = (main.templateoutput.Model.Diagnosticreport) getCurrentSession().get(main.templateoutput.Model.Diagnosticreport.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Diagnosticreport entity) 
	{
