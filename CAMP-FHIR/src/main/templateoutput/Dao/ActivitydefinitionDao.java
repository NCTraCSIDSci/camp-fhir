...
public class ActivitydefinitionDao {
	...
	public void persist( main.templateoutput.Model.Activitydefinition entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Activitydefinition entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Activitydefinition findById(String id) 
	{
		main.templateoutput.Model.Activitydefinition resource = (main.templateoutput.Model.Activitydefinition) getCurrentSession().get(main.templateoutput.Model.Activitydefinition.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Activitydefinition entity) 
	{
