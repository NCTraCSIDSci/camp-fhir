...
public class RelatedpersonDao {
	...
	public void persist( main.templateoutput.Model.Relatedperson entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Relatedperson entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Relatedperson findById(String id) 
	{
		main.templateoutput.Model.Relatedperson resource = (main.templateoutput.Model.Relatedperson) getCurrentSession().get(main.templateoutput.Model.Relatedperson.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Relatedperson entity) 
	{
