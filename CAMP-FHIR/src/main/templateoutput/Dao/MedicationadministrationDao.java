...
public class MedicationadministrationDao {
	...
	public void persist( main.templateoutput.Model.Medicationadministration entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Medicationadministration entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Medicationadministration findById(String id) 
	{
		main.templateoutput.Model.Medicationadministration resource = (main.templateoutput.Model.Medicationadministration) getCurrentSession().get(main.templateoutput.Model.Medicationadministration.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Medicationadministration entity) 
	{
