...
public class SlotDao {
	...
	public void persist( main.templateoutput.Model.Slot entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Slot entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Slot findById(String id) 
	{
		main.templateoutput.Model.Slot resource = (main.templateoutput.Model.Slot) getCurrentSession().get(main.templateoutput.Model.Slot.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Slot entity) 
	{
