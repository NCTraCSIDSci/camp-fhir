...
public class PractitionerDao {
	...
	public void persist( main.templateoutput.Model.Practitioner entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Practitioner entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Practitioner findById(String id) 
	{
		main.templateoutput.Model.Practitioner resource = (main.templateoutput.Model.Practitioner) getCurrentSession().get(main.templateoutput.Model.Practitioner.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Practitioner entity) 
	{
