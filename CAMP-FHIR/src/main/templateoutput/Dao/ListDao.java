...
public class ListDao {
	...
	public void persist( main.templateoutput.Model.List entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.List entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.List findById(String id) 
	{
		main.templateoutput.Model.List resource = (main.templateoutput.Model.List) getCurrentSession().get(main.templateoutput.Model.List.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.List entity) 
	{
	...
	{
		ScrollableResults resources = getCurrentSession().createQuery("FROM List")
