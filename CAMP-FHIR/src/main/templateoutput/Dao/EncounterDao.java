...
public class EncounterDao {
	...
	public void persist( main.templateoutput.Model.Encounter entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Encounter entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Encounter findById(String id) 
	{
		main.templateoutput.Model.Encounter resource = (main.templateoutput.Model.Encounter) getCurrentSession().get(main.templateoutput.Model.Encounter.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Encounter entity) 
	{
