...
public class PaymentreconciliationDao {
	...
	public void persist( main.templateoutput.Model.Paymentreconciliation entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Paymentreconciliation entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Paymentreconciliation findById(String id) 
	{
		main.templateoutput.Model.Paymentreconciliation resource = (main.templateoutput.Model.Paymentreconciliation) getCurrentSession().get(main.templateoutput.Model.Paymentreconciliation.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Paymentreconciliation entity) 
	{
