...
public class DocumentreferenceDao {
	...
	public void persist( main.templateoutput.Model.Documentreference entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Documentreference entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Documentreference findById(String id) 
	{
		main.templateoutput.Model.Documentreference resource = (main.templateoutput.Model.Documentreference) getCurrentSession().get(main.templateoutput.Model.Documentreference.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Documentreference entity) 
	{
