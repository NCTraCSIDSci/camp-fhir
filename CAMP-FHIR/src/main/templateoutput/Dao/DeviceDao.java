...
public class DeviceDao {
	...
	public void persist( main.templateoutput.Model.Device entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Device entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Device findById(String id) 
	{
		main.templateoutput.Model.Device resource = (main.templateoutput.Model.Device) getCurrentSession().get(main.templateoutput.Model.Device.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Device entity) 
	{
