...
public class GoalDao {
	...
	public void persist( main.templateoutput.Model.Goal entity) 
	{
		getCurrentSession().save(entity);
	}

	public void update( main.templateoutput.Model.Goal entity) 
	{
		getCurrentSession().update(entity);
	}

	public  main.templateoutput.Model.Goal findById(String id) 
	{
		main.templateoutput.Model.Goal resource = (main.templateoutput.Model.Goal) getCurrentSession().get(main.templateoutput.Model.Goal.class, id);
		return resource; 
	}
	
	public void delete(main.templateoutput.Model.Goal entity) 
	{
