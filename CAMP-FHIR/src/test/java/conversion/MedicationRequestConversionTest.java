...
public class MedicationRequestConversionTest {
	private static FhirContext ctx;
	private static MedicationRequestConversion conversion;
	private SessionFactory sessionFactory;
	public static ResourceDao resourceDao;
	private static List<MedicationRequest> fhirMedicationRequestList = new ArrayList<MedicationRequest>();
	private static List<main.java.com.campfhir.model.MedicationRequest> dbMedicationRequests;
	...
	public void setup() throws IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
		...
		cf.setResource("MedicationRequest");
		sessionFactory = HibernateBaseDB.getSessionFactory(cf, "in");
		Session session = sessionFactory.openSession();
		dbMedicationRequests = session.createQuery("from MedicationRequest", main.java.com.campfhir.model.MedicationRequest.class).list();
		session.close();

		conversion = new MedicationRequestConversion();
		for (main.java.com.campfhir.model.MedicationRequest MedicationRequest : dbMedicationRequests) {
			MedicationRequest fhirMedicationRequest = conversion.MedicationRequests(MedicationRequest);
			fhirMedicationRequestList.add(fhirMedicationRequest);
		}
