...
public class ObservationConversionTest {
	...
	private static ObservationConversion conversion;
	private SessionFactory sessionFactory;
	public static ResourceDao resourceDao;
	private static List<Observation> fhirObservationList = new ArrayList<Observation>();
	private static List<main.java.com.campfhir.model.Observation> dbObservations;
	...
	public void setup() throws IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
		...
		cf.setResource("Observation");
		sessionFactory = HibernateBaseDB.getSessionFactory(cf, "in");
		
		Session session = sessionFactory.openSession();
		dbObservations = session.createQuery("from Observation", main.java.com.campfhir.model.Observation.class).list();
		session.close();

		conversion = new ObservationConversion();
		for (main.java.com.campfhir.model.Observation Observation : dbObservations) {
			Observation fhirObservation = conversion.Observations(Observation);
			fhirObservationList.add(fhirObservation);
		}
